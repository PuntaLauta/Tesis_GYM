    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      {!user ? (
        <div className="space-y-6">
          <p className="mb-4">Iniciá sesión para acceder a tu panel.</p>
          <Link to="/login" className="inline-block px-3 py-2 bg-blue-600 text-white rounded">Ir al Login</Link>
        </div>
      ) : user.rol === 'cliente' ? (
        <div className="space-y-6">
          {loadingSocio ? (
            ...
            <>
              ...
              {diasHastaVencimiento !== null && diasHastaVencimiento <= 7 && socio && socio.estado === 'activo' && (
                <div className={`border-l-4 p-4 rounded-lg shadow ${
